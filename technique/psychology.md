...
### 6秒ルール
怒りを感じたら6秒待つ。怒りのピークは長くても6秒程度であり、この間に冷静さを取り戻せる可能性が高い。

### 怒りの記録
怒りを感じた出来事、その強度、原因を記録する。パターンを把握することで、自分の怒りの傾向を理解し、対処しやすくなる。

### コアビリーフの理解
怒りの背後にある「べき思考」（〜であるべき）を認識する。  
自分と他人の「べき」が異なることを理解し、許容範囲を広げることで怒りを軽減できる。
